"""
LLM Batch Inference Script for Task4
------------------------------------
...
def parse_args():
    parser = argparse.ArgumentParser(description="Batch inference using vLLM for Task4.")

    # Model and input/output paths
    parser.add_argument("--model-paths", type=str, nargs='+', required=True,
                        help="Paths to local LLaMA/Qwen models. Example: 'your_path/checkpoint'")
    parser.add_argument("--input-json-paths", type=str, nargs='+', required=True,
                        help="Paths to JSON input files. Example: 'your_path/gene_task4_test_1000_format_alpaca.json'")
    ...
    parser.add_argument("--gpu-ids", type=str, default="6,7",
